            ...
            <div className={classes.topBarMain}>
                ...
                <div className={classes.logo}>
                    <NavLink to={ `/manage/events` }>
                        <img src={getConfig("VITE_APP_LOGO_LIGHT", "/logos/hi-events-text-dark.svg?v=2")} alt={`${getConfig("VITE_APP_NAME", "Manav Samaj Setu Foundation Events")} logo`} className={classes.logo}/>
                    </NavLink>
                </div>
